...
export class ToolInputParser {
  ...
  private static extractPrimaryParam(toolName: string, params: Record<string, unknown>): string | null {
    ...
    const possibleParams = primaryParamMap[toolName] || ['path', 'file', 'query', 'command', 'url'];
